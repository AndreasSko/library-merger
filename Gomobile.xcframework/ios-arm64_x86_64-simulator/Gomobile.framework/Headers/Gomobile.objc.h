// Objective-C API for talking to github.com/AndreasSko/go-library-merger/gomobile Go package.
//   gobind -lang=objc github.com/AndreasSko/go-library-merger/gomobile
//
